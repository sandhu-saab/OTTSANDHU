...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002253089880")) #Your db channel Id
OWNER = os.environ.get("OWNER", "Sandhu7418") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "6157414954")) # Owner id
#--------------------------------------------
PORT = os.environ.get("PORT", "8001")
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://sukhwinder088877:singh8877@cluster0.u2gw0sc.mongodb.net/?appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "sukhwinder088877")
#--------------------------------------------
...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "d69bdc9eeef4d1cb0d2bb9733099a0282bdc64ac")
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 86400)) # Add time in seconds
TUT_VID = os.environ.get("TUT_VID","https://t.me/+dVRLYHXJztJlMmY9")
